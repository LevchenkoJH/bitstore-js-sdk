...
ChainTypes.operations = {
    ...
    asset_create_nf: 75,
    asset_update_nf: 76,
    asset_update_binded_data: 77,
    asset_issue_nf: 78,
    venv_create: 79,
    venv_account_register: 80,
    venv_update: 81,
    venv_update_options: 82,
    venv_file_system_create: 83,
    venv_file_system_update: 84,
    venv_file_system_update_options: 85,
    venv_file_header_create: 86,
    venv_file_header_update: 87,
    venv_file_header_update_options: 88,
    venv_file_header_vote: 89,
    venv_block_header_create: 90,
    venv_block_header_update: 91,
    venv_block_header_remove: 92,
    delegated_balance_authority_create: 93,
    delegated_balance_authority_update: 94,
    delegated_balance_allocate: 95,
    delegated_balance_update_authorities: 96,
    delegated_balance_refund: 97,
    storage_provider_register: 98,
    storage_auditor_register: 99,
    storage_account_reset: 100,
    storage_provider_apply_block: 101,
    storage_auditor_report: 102,
    venv_file_header_remove: 103,
};
