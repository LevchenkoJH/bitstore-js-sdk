...
ChainTypes.object_type = {
    ...
    venv_file_system: 25,
    venv_file_header: 26,
    venv_block_header: 27,
    delegated_balance_authority: 28,
    delegated_balance: 29,
    venv_block_property: 30,
    ml_subscription_level: 31,
    ml_subscription_level: 32,
};
...
ChainTypes.operations = {
    ...
    asset_issue_nf: 77,
    venv_create: 78,
    venv_account_register: 79,
    venv_update: 80,
    venv_update_options: 81,
    venv_file_system_create: 82,
    venv_file_system_update: 83,
    venv_file_system_update_options: 84,
    venv_file_header_create: 85,
    venv_file_header_update: 86,
    venv_file_header_update_options: 87,
    venv_file_header_vote: 88,
    venv_block_header_create: 89,
    venv_block_header_update: 90,
    venv_block_header_remove: 91,
    delegated_balance_authority_create: 92,
    delegated_balance_authority_update: 93,
    delegated_balance_allocate: 94,
    delegated_balance_update_authorities: 95,
    delegated_balance_refund: 96,
    storage_provider_register: 97,
    storage_auditor_register: 98,
    storage_account_reset: 99,
    storage_provider_apply_block: 100,
    storage_auditor_report: 101,
    venv_file_header_remove: 102,
    venv_file_header_like: 103,
    venv_file_header_copy: 104,
};
