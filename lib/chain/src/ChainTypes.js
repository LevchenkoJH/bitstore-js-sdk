...
ChainTypes.operations = {
    ...
    app_create: 79,
    app_update: 80,
    app_register_account: 81,
    file_create: 82,
    file_update: 83,
    file_update_options: 84,
    file_remove: 85,
    file_update_statistic: 86,
    file_copy: 87,
    file_vote: 88,
    order_group_create: 89,
    block_create: 90,
    block_update: 91,
    block_remove: 92,
    ...
    storage_upgrade_account: 98,
    storage_bucket_create: 99,
    storage_bucket_apply_block: 100,
    storage_bucket_audit_report: 101,
    product_create: 102,
    product_update: 103,
    product_plan_create: 104,
    product_plan_update: 105,
    product_subscribe: 106,
    product_unsubscribe: 107,
    product_renewal: 108,
    storage_bucket_block_released: 109,
};
