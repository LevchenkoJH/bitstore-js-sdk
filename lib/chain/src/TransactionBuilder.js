...
import {Apis, ChainConfig} from "bitstore-js-ws";
...
class TransactionBuilder {
    constructor(tx = null, custom_expiration = null) {
        this.signer_private_keys = [];
        custom_expiration += base_expiration_sec();

        if (custom_expiration)
            console.log('custom_expiration', custom_expiration);

        if (tx) {
            this.expiration = custom_expiration && tx.expiration < custom_expiration ? custom_expiration : tx.expiration;
            ...
            this.expiration = custom_expiration ? custom_expiration : 0;
            this.operations = [];
            this.signatures = [];
        }
    ...
    */
    ...
    set_required_fees(asset_id, removeDuplicates) {
        ...
        */
        ...
        // //DEBUG
        // console.log('... get_required_fees', operations, asset_id,flat_fees);
    }
