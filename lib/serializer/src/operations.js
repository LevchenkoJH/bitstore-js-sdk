...
export const storage_provider_create_operation_fee_parameters = new Serializer("storage_provider_create_operation_fee_parameters", {
    fee: uint64,
});

export const storage_provider_echo_operation_fee_parameters = new Serializer("storage_provider_echo_operation_fee_parameters", {
    fee: uint64,
});

export const storage_auditor_echo_operation_fee_parameters = new Serializer("storage_auditor_echo_operation_fee_parameters", {
    fee: uint64,
});
...
var fee_parameters = static_variant([
    ...
    storage_provider_create_operation_fee_parameters,
    storage_provider_echo_operation_fee_parameters,
    storage_auditor_echo_operation_fee_parameters,
...
export const storage_provider_create = new Serializer("storage_provider_create", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
    account_id: protocol_id_type("account"),
    extensions: set(future_extensions),
...
export const storage_provider_echo = new Serializer("storage_provider_echo", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
...
export const storage_auditor_echo = new Serializer("storage_auditor_echo", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
...
operation.st_operations = [
    ...
    storage_provider_echo,
    storage_auditor_echo,
