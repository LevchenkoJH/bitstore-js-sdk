...
export const venv_file_header_update_meta_operation_fee_parameters = new Serializer("venv_file_header_update_meta_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});
...
var fee_parameters = static_variant([
    ...
    venv_file_header_update_meta_operation_fee_parameters,
...
export const application_meta = new Serializer("application_meta", {//
...
export const signed_application_meta = new Serializer("signed_application_meta", {//
...
export const venv_file_header_create = new Serializer("venv_file_header_create", {
    ...
    name: string,
    signed_meta: optional(signed_application_meta),
    is_directory: bool,
    extensions: set(future_extensions),
});
...
export const venv_file_header_update_meta = new Serializer("venv_file_header_update_meta", {
    fee: asset,
    file_header_id_to_update: protocol_id_type("venv_file_header"),
    new_signed_meta: signed_application_meta,
    extensions: set(future_extensions),
});
...
export const venv_file_header_vote = new Serializer("venv_file_header_vote", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
    witness_account_id: protocol_id_type("account"),
...
export const venv_block_header_remove = new Serializer("venv_block_header_remove", {
    ...
    owner_account_id: protocol_id_type("account"),
    file_header_id_to_update: protocol_id_type("venv_file_header"),
    block_id_to_remove: optional(protocol_id_type("venv_block_header")),
    extensions: set(future_extensions),
});
