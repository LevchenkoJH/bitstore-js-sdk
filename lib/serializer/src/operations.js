...
export const asset_update_binded_data_operation_fee_parameters = new Serializer("asset_update_binded_data_operation_fee_parameters", {
    fee: uint64,
});
...
var fee_parameters = static_variant([
    ...
    asset_update_binded_data_operation_fee_parameters,
...
export const asset_update_nf = new Serializer("asset_update_nf", {
    ...
    issuer_account_id: protocol_id_type("account"),
    new_options: nf_asset_options,
    asset_id_to_update: protocol_id_type("asset"),
    extensions: set(future_extensions),
});

export const asset_update_binded_data = new Serializer("asset_update_binded_data", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
    owner_account_id: protocol_id_type("account"),
...
export const asset_issue_nf = new Serializer("asset_issue_nf", {
    ...
    issue_to_account_id: protocol_id_type("account"),
    extensions: set(future_extensions),
});
