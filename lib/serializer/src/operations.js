...
export const venv_file_header_deal = new Serializer("venv_file_header_deal", {//
    new_name: optional(string),
    new_fs_or_directory_id: object_id_type,
    new_signed_options: optional(signed_options),
});

var proposed_deal = static_variant([//
    venv_file_header_deal
]);
...
export const venv_file_header_create = new Serializer("venv_file_header_create", {
    ...
    is_directory: bool,
    copy_price: optional(asset),
    privacy_options: optional(uint16),
    extensions: set(future_extensions),
});
...
export const venv_file_header_update = new Serializer("venv_file_header_update", {
    ...
    new_name: string,
    new_content_type: optional(string),
    new_signed_options: optional(signed_options),
    reserve_bytes: optional(uint64),
    is_directory: optional(bool),
    new_copy_price: optional(asset),
    new_privacy_options: optional(uint16),
    extensions: set(future_extensions),
});
...
export const encrypted_key_data = new Serializer("encrypted_key_data", {
    broken_key: public_key,
...
export const venv_block_header_create = new Serializer("venv_block_header_create", {
    ...
    is_b64_encoded: bool,
    encrypted_keys: map(protocol_id_type("account"), encrypted_key_data),
    extensions: set(future_extensions),
});
