...
export const org_create_operation_fee_parameters = new Serializer("org_create_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});
...
var fee_parameters = static_variant([
    ...
    org_create_operation_fee_parameters,
    org_account_register_operation_fee_parameters,
    org_update_operation_fee_parameters,
    org_update_options_operation_fee_parameters,
    app_create_operation_fee_parameters,
    app_update_operation_fee_parameters,
    app_register_account_operation_fee_parameters,
    app_update_options_operation_fee_parameters,
    file_create_operation_fee_parameters,
    file_update_operation_fee_parameters,
    file_update_options_operation_fee_parameters,
    file_vote_operation_fee_parameters,
    block_create_operation_fee_parameters,
    block_update_operation_fee_parameters,
    block_remove_operation_fee_parameters,
    ...
    file_remove_operation_fee_parameters,
    // file_like_operation_fee_parameters,
    file_copy_operation_fee_parameters,
    product_subscribe_operation_fee_parameters,
    product_unsubscribe_operation_fee_parameters,
]);
