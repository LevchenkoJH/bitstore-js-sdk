...
export const venv_create_operation_fee_parameters = new Serializer("venv_create_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});

export const venv_account_register_operation_fee_parameters = new Serializer("venv_account_register_operation_fee_parameters", {
    fee: uint64,
});

export const venv_update_operation_fee_parameters = new Serializer("venv_update_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});

export const venv_update_options_operation_fee_parameters = new Serializer("venv_update_options_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});

export const venv_file_system_create_operation_fee_parameters = new Serializer("venv_file_system_create_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});

export const venv_file_system_update_operation_fee_parameters = new Serializer("venv_file_system_update_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});

export const venv_file_system_update_options_operation_fee_parameters = new Serializer("venv_file_system_update_options_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});

export const venv_file_header_create_operation_fee_parameters = new Serializer("venv_file_header_create_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});

export const venv_file_header_update_operation_fee_parameters = new Serializer("venv_file_header_update_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});

export const venv_file_header_update_options_operation_fee_parameters = new Serializer("venv_file_header_update_options_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});

export const venv_file_header_vote_operation_fee_parameters = new Serializer("venv_file_header_vote_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});

export const venv_block_header_create_operation_fee_parameters = new Serializer("venv_block_header_create_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});

export const venv_block_header_update_operation_fee_parameters = new Serializer("venv_block_header_update_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});

export const venv_block_header_remove_operation_fee_parameters = new Serializer("venv_block_header_remove_operation_fee_parameters", {
});
...
export const venv_file_header_remove_operation_fee_parameters = new Serializer("venv_file_header_remove_operation_fee_parameters", {
});

export const venv_file_header_like_operation_fee_parameters = new Serializer("venv_file_header_like_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32,
});

export const venv_file_header_copy_operation_fee_parameters = new Serializer("venv_file_header_copy_operation_fee_parameters", {
    fee: uint64,
});

export const ml_subscription_subscribe_operation_fee_parameters = new Serializer("ml_subscription_subscribe_operation_fee_parameters", {
    fee: uint64,
});

export const ml_subscription_unsubscribe_operation_fee_parameters = new Serializer("ml_subscription_unsubscribe_operation_fee_parameters", {
});
...
var fee_parameters = static_variant([
    ...
    asset_create_nf_operation_fee_parameters,
    asset_update_nf_operation_fee_parameters,
    asset_issue_nf_operation_fee_parameters,
    venv_create_operation_fee_parameters,
    venv_account_register_operation_fee_parameters,
    venv_update_operation_fee_parameters,
    venv_update_options_operation_fee_parameters,
    venv_file_system_create_operation_fee_parameters,
    venv_file_system_update_operation_fee_parameters,
    venv_file_system_update_options_operation_fee_parameters,
    venv_file_header_create_operation_fee_parameters,
    venv_file_header_update_operation_fee_parameters,
    venv_file_header_update_options_operation_fee_parameters,
    venv_file_header_vote_operation_fee_parameters,
    venv_block_header_create_operation_fee_parameters,
    venv_block_header_update_operation_fee_parameters,
    venv_block_header_remove_operation_fee_parameters,
    delegated_balance_authority_create_operation_fee_parameters,
    delegated_balance_authority_update_operation_fee_parameters,
    delegated_balance_allocate_operation_fee_parameters,
    delegated_balance_update_authorities_operation_fee_parameters,
    delegated_balance_refund_operation_fee_parameters,
    storage_provider_register_operation_fee_parameters,
    storage_auditor_register_operation_fee_parameters,
    storage_account_reset_operation_fee_parameters,
    storage_provider_apply_block_operation_fee_parameters,
    storage_auditor_report_operation_fee_parameters,
    venv_file_header_remove_operation_fee_parameters,
    venv_file_header_like_operation_fee_parameters,
    venv_file_header_copy_operation_fee_parameters,
    ml_subscription_subscribe_operation_fee_parameters,
    ml_subscription_unsubscribe_operation_fee_parameters,
]);
...
export const venv_file_header_options = new Serializer("venv_file_header_options", {//
    ...
    ref_block_prefix: uint32,
    description: string,
    linked_blocks_ids: map(string, protocol_id_type("venv_block_header")),
    extensions: set(future_extensions)
});
...
export const signed_options = new Serializer("signed_options", {//
    options: venv_file_header_options,
    signature: bytes(65),
    extensions: set(future_extensions)
});
...
export const proposed_deal = new Serializer("proposed_deal", {
    ...
    new_fs_or_directory_id: object_id_type,
...
export const asset_create_nf = new Serializer("asset_create_nf", {
    ...
    symbol: string,
    file_header_id_to_bind: protocol_id_type("venv_file_header"),
...
export const asset_update_nf = new Serializer("asset_update_nf", {
    ...
    new_file_header_id_to_bind: protocol_id_type("venv_file_header"),
...
export const venv_options = new Serializer("venv_options", {
    description: string,
    extensions: set(future_extensions),
});

export const venv_create = new Serializer("venv_create", {
    fee: asset,
    owner_account_id: protocol_id_type("account"),
    organisation: string,
    website: string,
    ...
    common_options: venv_options,
    extensions: set(future_extensions),
});

export const venv_account_register = new Serializer("venv_account_register", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
    account_id: protocol_id_type("account"),
    venv_id: protocol_id_type("venv"),
    extensions: set(future_extensions),
});

export const venv_update = new Serializer("venv_update", {
    fee: asset,
    owner_account_id: protocol_id_type("account"),
    venv_id_to_update: protocol_id_type("vanv"),
    new_organisation: string,
    new_website: string,
    new_options: optional(venv_options),
    new_active: optional(authority),
    new_asset_id: optional(protocol_id_type("asset")),
    extensions: set(future_extensions),
});

export const venv_update_options = new Serializer("venv_update_options", {
    fee: asset,
    owner_account_id: protocol_id_type("account"),
    venv_id_to_update: protocol_id_type("venv"),
    new_options: venv_options,
    extensions: set(future_extensions),
});

// export const venv_file_system_options = new Serializer("venv_file_system_options", {
...
// no implement
export const venv_file_system_create = new Serializer("venv_file_system_create", {
    fee: asset,
    // owner_account_id: protocol_id_type("account"),
    // venv_id: protocol_id_type("venv"),
    // app_or_service: string,
    // url: string,
    // common_options: venv_file_system_options,
    extensions: set(future_extensions),
});

// no implement
export const venv_file_system_update = new Serializer("venv_file_system_update", {
    fee: asset,
    // owner_account_id: protocol_id_type("account"),
    // file_system_id_to_update: protocol_id_type("file_system"),
    // new_app_or_service: string,
    // new_url: string,
    // new_options: optional(venv_file_system_options),
    extensions: set(future_extensions),
});

// no implement
export const venv_file_system_update_options = new Serializer("venv_file_system_update_options", {
    fee: asset,
    // owner_account_id: protocol_id_type("account"),
    // file_system_id_to_update: protocol_id_type("file_system"),
    // new_options: venv_file_system_options,
    extensions: set(future_extensions),
});

var access_policy = static_variant([
    asset,
    bool,
]);

export const venv_file_header_create = new Serializer("venv_file_header_create", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
    owner_account_id: protocol_id_type("account"),
    fs_or_directory_id: object_id_type,
    name: string,
    signed_options: optional(signed_options),
    reserve_bytes: optional(uint64),
    is_directory: bool,
    nf_collection_head_id_to_bind: optional(protocol_id_type("venv_file_header")),
    access_policy: optional(access_policy),
    extensions: set(future_extensions),
});

export const venv_file_header_update = new Serializer("venv_file_header_update", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
    owner_account_id: protocol_id_type("account"),
    file_header_id_to_update: protocol_id_type("venv_file_header"),
    new_fs_or_directory_id: optional(object_id_type),
    new_name: string,
    new_signed_options: optional(signed_options),
    reserve_bytes: optional(uint64),
    is_directory: optional(bool),
    new_access_policy: optional(access_policy),
    extensions: set(future_extensions),
});

export const venv_file_header_update_options = new Serializer("venv_file_header_update_options", {
    fee: asset,
    file_header_id_to_update: protocol_id_type("venv_file_header"),
...
export const venv_file_header_vote = new Serializer("venv_file_header_vote", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
    moderator_account_id: protocol_id_type("account"),
    votes: map(protocol_id_type("venv_file_header"), vote),
    extensions: set(future_extensions),
});

export const venv_block_header_create = new Serializer("venv_block_header_create", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
    owner_account_id: protocol_id_type("account"),
    file_header_id_to_update: protocol_id_type("venv_file_header"),
...
export const venv_block_header_update = new Serializer("venv_block_header_update", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
    owner_account_id: protocol_id_type("account"),
    file_header_id_to_update: protocol_id_type("venv_file_header"),
    block_id_to_update: protocol_id_type("venv_block_header"),
    hash: bytes(32),
    total_bytes: uint32,
    encrypted_keys: array(memo_data),
    extensions: set(future_extensions),
...
export const venv_block_header_remove = new Serializer("venv_block_header_remove", {
    fee: asset,
    owner_account_id: protocol_id_type("account"),
    block_ids_to_remove: set(protocol_id_type("venv_block_header")),
    extensions: set(future_extensions),
});
...
export const storage_provider_apply_block = new Serializer("storage_provider_apply_block", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
    provider_account_id: protocol_id_type("account"),
...
export const storage_auditor_report = new Serializer("storage_auditor_report", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
    provider_account_id: protocol_id_type("account"),
    block_id_to_apply: protocol_id_type("venv_block_header"),
    address: uint32,
    result: uint16,
    extensions: set(future_extensions),
});

export const venv_file_header_remove = new Serializer("venv_file_header_remove", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
    owner_account_id: protocol_id_type("account"),
    file_header_id_to_remove: protocol_id_type("venv_file_header"),
    extensions: set(future_extensions),
});

export const venv_file_header_like = new Serializer("venv_file_header_like", {
    delegated_balance_id: optional(protocol_id_type("delegated_balance")),
    fee: asset,
    voter_account_id: protocol_id_type("account"),
    votes: map(protocol_id_type("venv_file_header"), optional(bool)),
    extensions: set(future_extensions),
});

export const venv_file_header_copy = new Serializer("venv_file_header_copy", {
    fee: asset,
    buyer_account_id: protocol_id_type("account"),
    fs_or_directory_id_to_copy: object_id_type,
    file_header_id_to_copy: protocol_id_type("venv_file_header"),
    extensions: set(future_extensions),
});

export const ml_subscription_subscribe = new Serializer("ml_subscription_subscribe", {
    fee: asset,
    user_account_id: protocol_id_type("account"),
    level_id_to_subscribe: protocol_id_type("ml_subscription_level"),
    is_auto_renewal: bool,
    extensions: set(future_extensions),
});

export const ml_subscription_unsubscribe = new Serializer("ml_subscription_unsubscribe", {
    fee: asset,
    user_account_id: protocol_id_type("account"),
    level_id_to_unsubscribe: protocol_id_type("ml_subscription_level"),
    is_auto_renewal: bool,
    extensions: set(future_extensions),
});
...
operation.st_operations = [
    ...
    asset_issue_nf,
    venv_create,
    venv_account_register,
    venv_update,
    venv_update_options,
    venv_file_system_create,
    venv_file_system_update,
    venv_file_system_update_options,
    venv_file_header_create,
    venv_file_header_update,
    venv_file_header_update_options,
    venv_file_header_vote,
    venv_block_header_create,
    venv_block_header_update,
    venv_block_header_remove,
    ...
    storage_provider_apply_block,
    storage_auditor_report,
    venv_file_header_remove,
    venv_file_header_like,
    venv_file_header_copy,
    ml_subscription_subscribe,
    ml_subscription_unsubscribe,
];
